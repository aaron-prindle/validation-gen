...
func Validate_TestStruct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *TestStruct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj map[string][]string) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("limitedExtra"), obj.LimitedExtra, safe.Field(oldObj, func(oldObj *TestStruct) map[string][]string { return oldObj.LimitedExtra }))...)

	// field TestStruct.PositiveNumbers
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj map[string][]int) (errs field.ErrorList) {
			...
			return
		}(fldPath.Child("positiveNumbers"), obj.PositiveNumbers, safe.Field(oldObj, func(oldObj *TestStruct) map[string][]int { return oldObj.PositiveNumbers }))...)
