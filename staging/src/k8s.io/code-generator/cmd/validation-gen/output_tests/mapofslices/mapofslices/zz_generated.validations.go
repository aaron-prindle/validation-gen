...
func Validate_TestStruct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *TestStruct) (errs field.ErrorList) {
	...
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj map[string][]string) (errs field.ErrorList) {
			...
			errs = append(errs, validate.FixedResult(ctx, op, fldPath, obj, oldObj, false, "field TestStruct.ExtraValues")...)
			return
		}(fldPath.Child("extraValues"), obj.ExtraValues, safe.Field(oldObj, func(oldObj *TestStruct) map[string][]string { return oldObj.ExtraValues }))...)

	// field TestStruct.UnvalidatedMapOfSlices has no validation
	return errs
}
