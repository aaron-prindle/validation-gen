...
func Test(t *testing.T) {
	...
	st.Value(&Struct{D: "", M1: &M1{}}).ExpectValid()
	st.Value(&Struct{D: "", M2: &M2{}}).ExpectValid()

	st.Value(&Struct{D: "", M1: &M1{}, M2: &M2{}}).ExpectInvalid(
		field.Invalid(nil, "{m1, m2}", "must specify at most one of: `m1`, `m2`"),
	)

	st.Value(&Struct{D: DM1}).ExpectValid()
	...
	st.Value(&Struct{D: "", M1: &M1{}, M2: &M2{}}).OldValue(&Struct{D: "", M1: &M1{}, M2: &M2{}}).ExpectValid()
}
