...
var zeroOrOneOfMembershipForStructunion1 = validate.NewDiscriminatedUnionMembership("d1", [2]string{"u1m1", "U1M1"}, [2]string{"u1m2", "U1M2"})
var zeroOrOneOfMembershipForStructunion2 = validate.NewDiscriminatedUnionMembership("d2", [2]string{"u2m1", "U2M1"}, [2]string{"u2m2", "U2M2"})
...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs, validate.ZeroOrOneOfDiscriminatedUnion(ctx, op, fldPath, obj, oldObj, zeroOrOneOfMembershipForStructunion1, func(obj *Struct) string {
		if obj == nil {
			return ""
		}
	...
	errs = append(errs, validate.ZeroOrOneOfDiscriminatedUnion(ctx, op, fldPath, obj, oldObj, zeroOrOneOfMembershipForStructunion2, func(obj *Struct) string {
		if obj == nil {
			return ""
		}
