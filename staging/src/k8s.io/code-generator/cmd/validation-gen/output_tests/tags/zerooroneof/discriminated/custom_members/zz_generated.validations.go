...
var zeroOrOneOfMembershipForStruct = validate.NewDiscriminatedUnionMembership("d", [2]string{"m1", "CustomM1"}, [2]string{"m2", "CustomM2"})
...
func Validate_Struct(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *Struct) (errs field.ErrorList) {
	...
	errs = append(errs, validate.ZeroOrOneOfDiscriminatedUnion(ctx, op, fldPath, obj, oldObj, zeroOrOneOfMembershipForStruct, func(obj *Struct) string {
		if obj == nil {
			return ""
		}
		return string(obj.D)
